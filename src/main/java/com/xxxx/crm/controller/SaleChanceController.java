...
public class SaleChanceController extends BaseController {
    ...
    /**
     * 营销机会数据查询 分页多条件查询
     * 如果flag的值不为空，且值为1 则表示的是客户开发计划，否则查询营销机会数据
     * @param saleChanceQuery 营销机会查询类对象
     * @return Map对象
     */
    ...
    /**
     * 添加营销机会 后台接口
     * @param saleChance 营销机会实体类
     * @param request 请求对象
     * @return ResultInfo结果模型
     */
    ...
    public ResultInfo updateSaleChance(SaleChance saleChance) {
        // 调用service层的添加方法
        saleChanceService.updateChance(saleChance);
